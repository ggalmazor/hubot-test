declare module "hubot" {
  ...
  export class Adapter extends EventEmitter {
    ...
    async send(envelope: Envelope, ...strings: string[]): Promise<any>;

    async emote(envelope: Envelope, ...strings: string[]): Promise<any>;

    async reply(envelope: Envelope, ...strings: string[]): Promise<any>;

    async topic(envelope: Envelope, ...strings: string[]): Promise<any>;

    async play(envelope: Envelope, ...strings: string[]): Promise<any>;
    ...
    userForId(id: string, options?: {}): User | null;
    ...
    http(url: string): ScopedClient | null;
  }
  ...
  export class DataStore {
    ...
    getObject(key: string, objectKey: string): any;
  }
  ...
  export class Robot {
    ...
    constructor(adapter: Adapter, httpd: boolean, name: string, alias: string);
    ...
    async receive(message: Message): Promise<string[]>;
